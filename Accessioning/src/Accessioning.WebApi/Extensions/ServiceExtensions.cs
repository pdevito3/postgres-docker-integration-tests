namespace Accessioning.WebApi.Extensions
{
    using AutoMapper;
    ...
    public static class ServiceExtensions
    {
        ...
        public static void AddSwaggerExtension(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(config =>
            {
                ...
                config.IncludeXmlComments(string.Format(@$"{AppDomain.CurrentDomain.BaseDirectory}{Path.DirectorySeparatorChar}Accessioning.WebApi.xml"));
            });
        }
